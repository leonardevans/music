...
<div class="alert-light text-danger text-center" style="color:green;"> <?php echo $_GET['update_success'];?> </div>
<?php } ?>

<?php if(@$_GET['update_err'] == true) { ?>
<div class="alert-light text-danger text-center" style="color:red;"> <?php echo $_GET['update_err'];?> </div>
<?php } ?>
